<template>
  <div class="create-account">
    ...
    <modal name="credentials-modal" @closed="modalClosed">
      <div class="credentials">
        <p><b>Your username:</b> {{ user.email }}</p>
    ...
    methods: {
      createAccount() {
        ...
        if (this.errorMessage.length === 0) {
          ...
          axios
            .post(`${process.env.VUE_APP_BASE_URL}/auth/sign_up/`, post)
            .then(() => {
              successToaster(
              ...
              this.$modal.show('credentials-modal');
            })
            .finally(() => {
